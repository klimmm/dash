...
from data_process import load_insurance_dataframes, PeriodProcessor
...
period_processor_162 = PeriodProcessor(df_162)
period_processor_158 = PeriodProcessor(df_158)

end_quarter_options_162 = period_processor_162.get_year_quarter_options()
end_quarter_options_158 = period_processor_158.get_year_quarter_options()
