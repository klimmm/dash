...
def setup_insurance_lines_tree_callbacks(app: dash.Dash, insurance_lines_tree_162, insurance_lines_tree_158):
    @app.callback(
    ...
    def update_lines_checkbox_expansion_state(
        ...
        try:
            ...
            insurance_lines_tree = (
                insurance_lines_tree_162 if reporting_form == '0420162' 
                else insurance_lines_tree_158
            )
    ...
    def update_lines_checkbox_tree(line_state, expansion_state, reporting_form):
        ...
        insurance_lines_tree = insurance_lines_tree_162 if reporting_form == '0420162' else insurance_lines_tree_158
